...
const Header = () => {
    ...
    return(
        <>
            <Popover className="relative  shadow-lg bg-gray-100">
                           ...
                           <Link href="/">
                               <a >
                                   <img
                                       ...
                                       src={"/assets/images/logo-nwse-lg.png"}
                                       alt=""
                                   />
                               </a>
                           </Link>
                            ...
                            <div className="py-6 px-5 space-y-6">
                                ...
                                <div>
                                    <p className="mt-6 text-center text-base font-medium text-gray-500">
                                        Existing customer?{' '}
                                        <a href="#" onClick={handleSignOut} className="text-indigo-600 hover:text-indigo-500">
                                            Log Out
                                        </a>
                                    </p>
                                </div>
